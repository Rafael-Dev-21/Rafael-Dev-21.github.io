...
<div class="SplashScreen">
  ...
  <input class="StartButton" type="button" value="Começar">
</div>
<div class="FinishScreen">
  ...
  <input class="StartButton" type="button" value="Recomeçar">
</div>
<canvas id="canvasArea" class="game BLOG_video_embed" width="400" height="400">Seu browser parece não suportar html5. Por favor, atualize-o ou adquira um que suporte html5.</canvas>
</div>
