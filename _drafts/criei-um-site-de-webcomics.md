---
title: Criei Um Site Para Minhas WebComics!
date:
categories:
  - rafael-dev-21
tags:
...
layout: post
last_modified_at:
description: Criei um novo website para minhas webcomics. Por que eu decidi criar um site ao invés de usar um serviço existente? descubra cricando em
comments: true
math: false
toc: false
---

O título não foi clickbait. E se você veio pela grade de posts, o sumário também não. Eu andei trabalhando num projeto da qual tinha uma certa insegurança em realizar.

Recentemente, finalmente decidir o pôr em ação.
...
<a href="https://rafa4comics.netlify.app/comic/gojumpjr/001-simple-job/" hreflang="en">Aqui</a> um link para a primeira página publicada. A história se chama Go Jump Jr., e é uma comédia de ficção ciêtifíca que acompanha um capitão espacial preguiçoso e suas aventuras e enrascadas.
